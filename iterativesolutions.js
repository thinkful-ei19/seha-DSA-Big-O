...
// O(n) linear run time complexity. The performance will grow linearly
// and O(n) have run times are proportionalto the size of the input data set. 
...
// O(n) linear run time complexity. directly proportional to the size of the input data set. 
...
// O(n) linear run time complexity. directly proportional to the size of the input data set. 
//if the string is longer it will requiure more operation.
...
// O(n) linear run time complexity. directly proportional to the size of the input data set.
// if the input increase it will requiure more operation.
...
//Linear O(n) linear run time complexity. as input increases, number of oerations increases
