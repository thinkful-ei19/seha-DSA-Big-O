...
// O(n) linear run time complexity. if the num increases the time will grow as well. 
//directly proprtional to input size. 
...
// O(n) linear run time complexity. if the array gets bigger the time will grow as well. 
//directly proprtional to input size. 
...
// O(n) linear run time complexity. if the string gets longer the reversing string will
// require more time. 
...
// O(n) linear run time complexity.
...
//O(n^k) Polynomial run time complexity. performance is directly proportional to the square of the size 
